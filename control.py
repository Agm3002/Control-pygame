...
while True:
    ...
    if Keys[pygame.K_l]: screen.blit(crosshair, (35, 60))
    if Keys[pygame.K_j]: screen.blit(crosshair, (200, 100))
    if Keys[pygame.K_i]: screen.blit(crosshair, (200, 100)) 
    if Keys[pygame.K_b]: screen.blit(crosshair, (196, 143))
    if Keys[pygame.K_a]: screen.blit(crosshair, (222, 122))
    if Keys[pygame.K_y]: screen.blit(crosshair, (174, 122))
